...
import type { ProductForm, ProductDetail, BrandListItem, CategoryListItem } from '@/services/products'
import { getProductById, createProduct, updateProduct, getBrands, getCategories } from '@/services/products'
